  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">AI-powered sentiment analysis from trusted Indian financial sources</p>
      </div>
      ...
      <div className="space-y-4">
        {news.map((item) => {
          ...
          return (
            <Card key={item.id} className="bg-card/50 border-border hover:border-primary/50 transition-colors backdrop-blur-sm">
